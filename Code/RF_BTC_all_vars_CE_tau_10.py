...
if __name__ == "__main__":
    data_df = pd.read_csv('../Data/BTC-USD/BTC-USD_all_vars.csv', encoding='utf-8', sep = ',', low_memory=False, header = 0, skiprows = 0, skipinitialspace=True, parse_dates = ['date'])
