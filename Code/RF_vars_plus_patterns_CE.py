...
if __name__ == "__main__":
	...
	scoring_fns = ['Gain_to_pain_ratio_fixed_trans_cost', 'Gain_to_pain_ratio_variable_trans_cost', 'Calmar_ratio_fixed_trans_cost',							
	...
	for scoring_fn in scoring_fns:
		...
		forecasts_df, scores_df, opt_params_df, importances_df, SHAP_df = forecast.rolling_forecast(data_df,
																																								...
																																								objective_name = f'{use_model}_{use_data}_{loss_fn_name}', # the name of the objective function
																																								...
																																								n_jobs = 40, # the number of workers for multiprocessing
																																							)
