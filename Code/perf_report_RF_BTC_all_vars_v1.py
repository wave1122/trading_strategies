...
def perf_report(   invest_window = 100, # an investment period
    ...
    price_df = pd.read_csv('../Data/BTC-USD/BTC-USD.csv', encoding='utf-8', sep = ',', low_memory = False, header = 0, skiprows = 0, skipinitialspace = True, usecols = ['date', 'Close', 'RF'], parse_dates = ['date'])
...
if __name__ == "__main__":
    ...
    # use_model = 'RF_BTC_all_vars'
    use_model = 'RF_BTC_all_vars_plus_patterns'
