...
import forecast_directional_movement_v4 as forecast
import custom_losses_v1 as closs

if __name__ == "__main__":
    data_df = pd.read_csv('../Data/BTC-USD/BTC-USD_all_vars_plus_patterns.csv', encoding='utf-8', sep = ',', low_memory=False, header = 0, skiprows = 0, skipinitialspace=True, parse_dates = ['date'])
    
    tau = 12 # this is a forecast horizon that can take value in [2, 4, 6, 8, 10, 12]
    ...
    use_data = 'BTC_all_vars_plus_patterns'
    ...
    scoring_fns = ['Accuracy', 'AUC', 'Gain_to_pain_ratio_fixed_trans_cost', 'Calmar_ratio_fixed_trans_cost', 'Sharpe_ratio_fixed_trans_cost', 'Sortino_ratio_fixed_trans_cost', \
                                                                                                                                                                                                                                                            'CECPP_fixed_trans_cost']   
